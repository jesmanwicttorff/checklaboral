...
class DropProcedureEliminarTrabajador extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP PROCEDURE `EliminarTrabajador`;");
    }
    ...
    {
        DB::unprepared("DROP PROCEDURE `EliminarTrabajador`;");
        DB::unprepared("CREATE PROCEDURE `EliminarTrabajador`(
	IN `Rut` VARCHAR(50),
