...
class SeedAddReportetransversales extends Migration
{

  static private $gstrModule = "reportetransversales";
  static private $gstrModuleTitle = "Transversales";
  static private $gstrModuleNote = "Transversales";
