...
class CreateTblDiferenciasCalculosTemporalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_diferencias_calculos_temporal', function (Blueprint $table) {
            $table->increments('id');
            $table->date('periodo');
    ...
    {
        Schema::drop('tbl_diferencias_calculos_temporal');
    }
}
