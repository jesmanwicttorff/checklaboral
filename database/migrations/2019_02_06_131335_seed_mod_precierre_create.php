...
class SeedModPrecierreCreate extends Migration
{

  static private $gstrModule = "precierre";
  static private $gstrModuleTitle = "Precierre check laboral";
  static private $gstrModuleNote = "Precierre check laboral";
