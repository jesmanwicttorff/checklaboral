...
class AlterFnCierreLaboralMaestroPersonasYDiferencias extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        BEGIN
                                      ...
                                      BEGIN
                                         ...
                                         SELECT DISTINCT pdatPeriodo, tbl_personas.IdPersona, tbl_contratos_personas.contrato_id, tbl_contratos_personas.idcontratista, now(), now()
                                         FROM tbl_personas
                                         ...
                                         INSERT INTO tbl_personas_maestro(periodo, idpersona, contrato_id, idcontratista, created_at, updated_at)
                                         SELECT DISTINCT pdatPeriodo, tbl_personas.IdPersona, tbl_contrato.contrato_id, tbl_contrato.idcontratista, now(), now()
                                         FROM tbl_personas
                                         ...
                                         WHERE EXISTS (SELECT 1
                                                       ...
                                                       AND IFNULL(tbl_movimiento_personal.FechaEfectiva,"0000-00-00") != "0000-00-00"
                                      ...
                                      BEGIN
                                            INSERT INTO tbl_diferencias_nc_personas (periodo,
                                                        ...
                                                        where tbl_documentos.FechaFiniquito <= pdatPeriodo
                                                        and exists (select 1 
                                                                    from tbl_personas_maestro 
                                                                    where tbl_personas_maestro.periodo = pdatPeriodo
                                                                    and tbl_personas_maestro.Idpersona = tbl_documentos.IdEntidad);
    ...
    public function down()
    {
        ...
        BEGIN
                                      ...
                                      BEGIN
                                         ...
                                         INNER JOIN tbl_movimiento_personal ON tbl_movimiento_personal.IdPersona = tbl_personas.IdPersona 
                                         INNER JOIN tbl_contrato ON tbl_movimiento_personal.contrato_id = tbl_contrato.contrato_id
                                         WHERE tbl_movimiento_personal.createdOn <= LAST_DAY(pdatPeriodo)
                                      ...
                                      -- Insertamos las no conformidades automaticamente de personas
                                      -- ----------------------------------------------------------------------------------------------------------------------------------------------
                                      BEGIN
                                            INSERT INTO tbl_diferencias_nc_personas (periodo,
                                                        IdDocumento,
