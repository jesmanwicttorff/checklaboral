...
class AlterFnCierreLaboralCompletaFechaEfectivaMaestro extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        BEGIN
                            ...
                            BEGIN
                                ...
                                -- insertamos personas que deban un documento y que haya recibido movimiento en la fecha pero 
                                INSERT INTO tbl_personas_maestro(periodo, idpersona, contrato_id, idcontratista, Estatus, FechaEfectiva, created_at, updated_at)
                                SELECT DISTINCT pdatPeriodo, tbl_personas.IdPersona, tbl_contrato.contrato_id, tbl_contrato.idcontratista, "Vigente", (select max(FechaEfectiva) from tbl_movimiento_personal where tbl_movimiento_personal.IdPersona = tbl_personas.IdPersona and tbl_movimiento_personal.contrato_id = tbl_contrato.contrato_id and tbl_movimiento_personal.IdAccion = 1 and ifnull(tbl_movimiento_personal.Motivo,0) != 1) as FechaEfectiva, now(), now()
                                FROM tbl_personas
                                ...
                                WHERE EXISTS (SELECT 1
                                            ...
                                            AND tbl_movimiento_personal.IdAccion = 2
                                ...
                                -- insertamos personas que deban un documento y que haya recibido movimiento en la fecha pero 
                                INSERT INTO tbl_personas_maestro(periodo, idpersona, contrato_id, idcontratista, Estatus, FechaEfectiva, created_at, updated_at)
                                SELECT DISTINCT pdatPeriodo, tbl_personas.IdPersona, tbl_contrato.contrato_id, tbl_contrato.idcontratista, "Finiquitado", (select max(FechaEfectiva) from tbl_movimiento_personal where tbl_movimiento_personal.IdPersona = tbl_personas.IdPersona and tbl_movimiento_personal.contrato_id = tbl_contrato.contrato_id and tbl_movimiento_personal.IdAccion = 2 and ifnull(tbl_movimiento_personal.Motivo,0) != 1) as FechaEfectiva, now(), now()
                                FROM tbl_personas
                                INNER JOIN tbl_documentos ON tbl_documentos.entidad = 3 and tbl_documentos.IdEntidad = tbl_personas.IdPersona and tbl_documentos.IdEstatus in (1,2,3)
                                INNER JOIN tbl_tipos_documentos on tbl_tipos_documentos.IdTipoDocumento = tbl_documentos.IdTipoDocumento and tbl_tipos_documentos.ControlCheckLaboral = 1
                                INNER JOIN tbl_contrato ON tbl_documentos.contrato_id = tbl_contrato.contrato_id
                                ...
                                INSERT INTO tbl_personas_maestro(periodo, idpersona, contrato_id, idcontratista, Estatus, FechaEfectiva, created_at, updated_at)
                                SELECT DISTINCT pdatPeriodo, tbl_personas.IdPersona, tbl_contrato.contrato_id, tbl_contrato.idcontratista, "Finiquitado", max(tbl_movimiento_personal.FechaEfectiva), now(), now()
                                FROM tbl_personas
                                ...
                                AND NOT EXISTS (SELECT 1 
                                                ...
                                                AND tbl_personas_maestro.contrato_id = tbl_contrato.contrato_id)
                                AND ifnull(tbl_contrato.cont_estado,1) != 2
                                GROUP BY tbl_personas.IdPersona, 
                                        tbl_contrato.contrato_id, 
                            ...
                            BEGIN
                                ...
                                SELECT  pdatPeriodo, 
                                        ...
                                        ifnull(tbl_documentos.contrato_id,0) as contrato_id,
                                ...
                                and ifnull(tbl_documentos.FechaEmision,pdatPeriodo) <= pdatPeriodo
                                and exists (select 1 
                                            from tbl_personas_maestro 
                                            where tbl_personas_maestro.periodo = pdatPeriodo 
                            ...
                            BEGIN
                                INSERT INTO tbl_diferencias_nc_personas (periodo,
                                            ...
                                            FROM (
                                                ...
                                                AND tbl_tipos_documentos.ControlCheckLaboral = 1) as tbl_documentos
                        ...
                        BEGIN
                            ...
                            WHERE tbl_documentos.entidad in (1, 2, 6)
                            AND ifnull(tbl_documentos.FechaEmision,pdatPeriodo) <= pdatPeriodo
                            AND tbl_tipos_documentos.ControlCheckLaboral = 1
                            AND EXISTS (SELECT 1 
                                        FROM tbl_contrato_maestro 
