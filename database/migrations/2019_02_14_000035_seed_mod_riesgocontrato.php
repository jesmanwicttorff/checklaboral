...
class SeedModRiesgocontrato extends Migration
{
  static private $gstrModule = "riesgocontrato";
  static private $gstrModuleTitle = "Reporte de riesgo";
  static private $gstrModuleNote = "Reporte de riesgo";
