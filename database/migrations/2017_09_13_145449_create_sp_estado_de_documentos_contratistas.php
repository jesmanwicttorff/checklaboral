...
class CreateSpEstadoDeDocumentosContratistas extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared("
            CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_Estado_de_Documentos_Contatistas`(
                IN contatistas VARCHAR(256)
            )
            BEGIN 
