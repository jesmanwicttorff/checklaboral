...
class AlterSpLevantaSolicitudesPeriodicasContratoNull extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("DROP PROCEDURE IF EXISTS `spLevantaSolicitudesPeriodicas`;");
        DB::unprepared("CREATE DEFINER=`root`@`localhost` PROCEDURE `spLevantaSolicitudesPeriodicas`( pintPeriodicidad INT, pintIdProceso INT, pintMeses INT )
            BEGIN
                    
                        /* pintPeriodicidad '1' => 'Mensual' ,  '2' => 'Trimestral' , '3' => 'Semestral' , '4' => 'Anual' */
                        IF pintMeses IS NULL THEN
                                        SET pintMeses := 0;
                                    END IF;
                        ...
                        /* Insertamos los requisitos a contratistas */
                            insert into tbl_documentos(IdRequisito, 
                                        ...
                                        contrato_id,
                                        IdContratista) 
                            select distinct tbl_requisitos.IdRequisito, 
                                        ...
                                        CONCAT(DATE_FORMAT(DATE_ADD(CURDATE(), INTERVAL pintMeses MONTH),'%Y-%m'),'-01') as FechaEmision,
                                        0 as contrato_id,
                                        tbl_requisitos.IdContratista
                            from (select distinct tbl_requisitos.*, 
                            ...
                            and not exists (select 1 
                                                            ...
                                                            and tbl_documentos.FechaEmision = CONCAT(DATE_FORMAT(DATE_ADD(CURDATE(), INTERVAL pintMeses MONTH),'%Y-%m'),'-01')
