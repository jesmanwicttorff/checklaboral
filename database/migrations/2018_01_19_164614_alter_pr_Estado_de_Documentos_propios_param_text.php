...
class AlterPrEstadoDeDocumentosPropiosParamText extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("
            CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_Estado_de_Documentos_propios`( IN contratistas TEXT, IN contratos TEXT,IN pintIdPerfil INTEGER )
            BEGIN 
