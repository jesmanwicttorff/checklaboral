...
class AlterFnCierreLaboralTrabajadoresConO extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        BEGIN
                      ...
                      BEGIN
                         ...
                         SELECT DISTINCT pdatPeriodo, tbl_personas_maestro.idcontratista, tbl_personas_maestro.contrato_id, count(tbl_personas_maestro.idpersona), 0, 0, 0, now(), now()
