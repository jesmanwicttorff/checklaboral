...
class SeedModReportedesempenocontrato extends Migration
{
  static private $gstrModule = "reportedesempenocontrato";
  static private $gstrModuleTitle = "Reporte desempeño";
  static private $gstrModuleNote = "Reporte desempeño";
