...
class AlterTrgSetDocumentsModificaDocumentos extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("CREATE DEFINER=`root`@`localhost` TRIGGER `setDocuments` 
                        AFTER INSERT ON `tbl_contratos_personas` FOR EACH ROW
                        BEGIN
