...
class AlterSpEliminarTrabajadorAhoraConAcreditacion extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        //     e.   Elimina los documentos historicos en las tabla tbl_documentos_rep_historico.
        //     f.   Elimina los registros de la acreditacion en la tabla tbl_personas_acreditacion.
