...
class AlterFunctionComprobarAccesosAddSubcontratistas extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("
            CREATE DEFINER=`root`@`localhost` FUNCTION  `fnComprobarAccesos`(lintIdPersona int)
            RETURNS int
            BEGIN
                            ...
                            ELSE
                                ...
                                ELSE
                                    ...
                                    INTO lintContadorsubcontt
                                     FROM tbl_documentos
                                    INNER JOIN tbl_tipos_documentos ON tbl_tipos_documentos.IdTipoDocumento = tbl_documentos.IdTipoDocumento AND tbl_tipos_documentos.BloqueaAcceso = 'SI'
                                    INNER JOIN tbl_contratos_subcontratistas on tbl_documentos.IdEntidad=tbl_contratos_subcontratistas.IdSubContratista
                                    INNER JOIN tbl_contrato ON  tbl_contratos_subcontratistas.contrato_id = tbl_contrato.contrato_id
                                    INNER JOIN tbl_contratos_personas ON tbl_contrato.contrato_id = tbl_contratos_personas.contrato_id
