...
class SeedAddReportenoconformidades extends Migration
{

  static private $gstrModule = "reportenoconformidades";
  static private $gstrModuleTitle = "Reporte no conformidades";
  static private $gstrModuleNote = "Reporte no conformidades";
