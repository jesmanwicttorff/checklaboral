...
class CoregroupsController extends Controller {
	...
	public $module = 'coregroups';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Coregroups();
		$this->modelview = new  \App\Models\Maeasociaciongrup();
		...
		$this->data = array(
			...
			'pageModule'		=> 'coregroups',
			'pageUrl'			=>  url('coregroups'),
	...
	public function getIndex()
	{
		...
		return view('coregroups.index',$this->data);
	}	
	...
	{ 
		...
		$pagination->setPath('coregroups/data');
		...
		return view('coregroups.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('coregroups.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['subgrid']		= (isset($this->info['config']['subgrid']) ? $this->info['config']['subgrid'] : array());
			return view('coregroups.view',$this->data);
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			\DB::table('tb_assoccgroup')->whereIn('group_id',$request->input('ids'))->delete();
			return response()->json(array(
				'status'=>'success',
	...
	public static function display( )
	{
		...
		$model  = new Coregroups();
		$info = $model::makeInfo('coregroups');
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('coregroups.public.view',$data);
			} 
			...
			return view('coregroups.public.index',$data);			
		}
