...
class RiesgoController extends Controller {
	...
	public function getIndex( Request $request )
	{
		...
		return view('checklaboral.riesgo.index',$this->data);
	}
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('checklaboral.riesgo.form',$this->data);
	}
	...
	public function getShow(Request $request, $id = null)
	{
		...
		$this->data['DataRiesgo'] = $lobjCheckLaboral->LoadDataRiesgo($larrParametros,$id);
	...
	public function getTransversal(Request $request, $id = null)
	{
		...
		$this->data['DataRiesgo'] = $lobjCheckLaboral->LoadDataRiesgo($larrParametros,null,null,$id);
		...
		$this->data['access']		= $this->access;
		return view('checklaboral.riesgo.transversal',$this->data);
	}
