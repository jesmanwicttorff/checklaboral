...
use App\Models\Requisitosroles;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class RequisitosrolesController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'requisitosroles';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Requisitosroles();
		...
		$this->data = array(
			...
			'pageModule'		=> 'requisitosroles',
			'pageUrl'			=>  url('requisitosroles'),
	...
	public function getIndex()
	{
		...
		return view('requisitosroles.index',$this->data);
	}	
	...
	{ 
		...
		$pagination->setPath('requisitosroles/data');
		...
		return view('requisitosroles.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('requisitosroles.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['subgrid']		= (isset($this->info['config']['subgrid']) ? $this->info['config']['subgrid'] : array());
			return view('requisitosroles.view',$this->data);
	...
	public static function display( )
	{
		...
		$model  = new Requisitosroles();
		$info = $model::makeInfo('requisitosroles');
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('requisitosroles.public.view',$data);
			} 
			...
			return view('requisitosroles.public.index',$data);			
		}
