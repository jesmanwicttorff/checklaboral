...
class CargafController extends Controller {
	...
	public $module = 'cargaf';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Cargaf();
	...
	public function getIndex()
	{
		...
		return view('cargaf.index',$this->data);
	}	
	...
	{ 
		...
		$pagination->setPath('cargaf/data');
		...
		return view('cargaf.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('cargaf.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['subgrid']		= (isset($this->info['config']['subgrid']) ? $this->info['config']['subgrid'] : array());
			return view('cargaf.view',$this->data);
	...
	public static function display( )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('cargaf.public.view',$data);
			} 
			...
			return view('cargaf.public.index',$data);			
		}
