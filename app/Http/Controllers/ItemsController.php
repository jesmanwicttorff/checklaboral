...
class ItemsController extends Controller {
	...
	public function __construct() 
	{
		...
		$this->modelview = new  \App\Models\Itemsdetail();
	...
	{ 
		...
		return view('items.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		return view('items.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['subgrid']		= (isset($this->info['config']['subgrid']) ? $this->info['config']['subgrid'] : array());
			return view('items.view',$this->data);
	...
	public static function display( )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('items.public.view',$data);
			} 
			...
			return view('items.public.index',$data);			
		}
