...
class documentos extends Sximo  {
	...
	public function Persona() {
		$lobjInstancia =  $this->belongsTo('App\Models\Personas', 'IdEntidad', 'IdPersona');
	...
	public function DocumentosRelacionados() {
		return $this->hasMany('App\Models\Documentosrelacion', 'IdDocumentoRelacion', 'IdDocumento');
	}
	...
	public function estatu(){
		return $this->hasOne('App\Models\documentoestatus', 'IdEstatus', 'IdEstatus');
	}
