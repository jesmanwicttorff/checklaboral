...
class documentosmesanterior extends Sximo  {
	...
	public static function queryWhere(  ){
		...
		return " WHERE tbl_documentos.IdDocumento IS NOT NULL and tbl_documentos.IdEstatus != 99 AND tbl_documentos.FechaEmision=concat(substring(DATE_SUB(curdate(), INTERVAL 1 MONTH),1,8),'01') AND tbl_tipos_documentos.Acreditacion = 0 ";
	}
